 ...
 {
  {
   CCSwipe* tolua_ret = (CCSwipe*)  CCSwipe::create();
      ...
      toluafix_pushusertype_ccobject(tolua_S, nID, pLuaID, (void*)tolua_ret,"CCSwipe");
 ...
 {
  {
   CCSwipeGestureRecognizer* tolua_ret = (CCSwipeGestureRecognizer*)  CCSwipeGestureRecognizer::create();
      ...
      int nID = (tolua_ret) ? (int)tolua_ret->m_uID : -1;
      int* pLuaID = (tolua_ret) ? &tolua_ret->m_nLuaID : NULL;
      toluafix_pushusertype_ccobject(tolua_S, nID, pLuaID, (void*)tolua_ret,"CCSwipeGestureRecognizer");
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
...
//  CCCallFunc* sel = (CCCallFunc*)  CCCallFunc::create(nHandler);
 ...
 {
  {
   CCTap* tolua_ret = (CCTap*)  CCTap::create();
      int nID = (tolua_ret) ? (int)tolua_ret->m_uID : -1;
      int* pLuaID = (tolua_ret) ? &tolua_ret->m_nLuaID : NULL;
      toluafix_pushusertype_ccobject(tolua_S, nID, pLuaID, (void*)tolua_ret,"CCTap");
 ...
 {
  {
   CCTapGestureRecognizer* tolua_ret = (CCTapGestureRecognizer*)  CCTapGestureRecognizer::create();
      int nID = (tolua_ret) ? (int)tolua_ret->m_uID : -1;
      int* pLuaID = (tolua_ret) ? &tolua_ret->m_nLuaID : NULL;
      toluafix_pushusertype_ccobject(tolua_S, nID, pLuaID, (void*)tolua_ret,"CCTapGestureRecognizer");
 ...
 {
  {
   CCPan* tolua_ret = (CCPan*)  CCPan::create();
      int nID = (tolua_ret) ? (int)tolua_ret->m_uID : -1;
      int* pLuaID = (tolua_ret) ? &tolua_ret->m_nLuaID : NULL;
      toluafix_pushusertype_ccobject(tolua_S, nID, pLuaID, (void*)tolua_ret,"CCPan");
...
#endif
   tolua_pushusertype(tolua_S,(void*)&self->delta,"CCPoint");
 return 1;
}
#endif //#ifndef TOLUA_DISABLE
 ...
 {
  {
   CCPanGestureRecognizer* tolua_ret = (CCPanGestureRecognizer*)  CCPanGestureRecognizer::create();
      int nID = (tolua_ret) ? (int)tolua_ret->m_uID : -1;
      int* pLuaID = (tolua_ret) ? &tolua_ret->m_nLuaID : NULL;
      toluafix_pushusertype_ccobject(tolua_S, nID, pLuaID, (void*)tolua_ret,"CCPanGestureRecognizer");
 ...
 {
  {
   CCPinch* tolua_ret = (CCPinch*)  CCPinch::create();
      int nID = (tolua_ret) ? (int)tolua_ret->m_uID : -1;
      int* pLuaID = (tolua_ret) ? &tolua_ret->m_nLuaID : NULL;
      toluafix_pushusertype_ccobject(tolua_S, nID, pLuaID, (void*)tolua_ret,"CCPinch");
 ...
 {
  {
      ...
      int nID = (tolua_ret) ? (int)tolua_ret->m_uID : -1;
      int* pLuaID = (tolua_ret) ? &tolua_ret->m_nLuaID : NULL;
      toluafix_pushusertype_ccobject(tolua_S, nID, pLuaID, (void*)tolua_ret,"CCPinchGestureRecognizer");
...
TOLUA_API int tolua_cocos2dx_x_extension_gesture_recognizer_open (lua_State* tolua_S)
{
 ...
 tolua_beginmodule(tolua_S,NULL);
  ...
  tolua_cclass(tolua_S,"CCSwipe","CCSwipe","CCObject",NULL);
...
//   tolua_function(tolua_S,"create",tolua_cocos2dx_x_extension_gesture_recognizer_CCGestureRecognizer_create00);
  ...
  tolua_cclass(tolua_S,"CCTap","CCTap","CCObject",NULL);
  ...
  tolua_endmodule(tolua_S);
  tolua_cclass(tolua_S,"CCPan","CCPan","CCObject",NULL);
  ...
  tolua_cclass(tolua_S,"CCPinch","CCPinch","CCObject",NULL);
